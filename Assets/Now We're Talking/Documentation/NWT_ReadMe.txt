Now We're Talking! by Chatterware release version 1.09. October 2023.

Thanks for purchasing 'Now We're Talking!' from Chatterware.  


New features in V1.09
SPRITE MOUTHS 
Chatterware are pleased to introduce 'Sprite Mouths' to 'Now We're Talking!'.  This powerful new way to represent your low polygon character speaking is coming as a free upgrade to the base asset.  See documentation for how to use Sprite Mouths, essentially a spritemouth uses sprites to represent the animated mouth.  You can have as many 'frames' of animation as you wish, as long as you ensure a Sprite Renderer for each frame is referenced in the prefab.  In this base pack we have provided a number of frames to get you started. 
