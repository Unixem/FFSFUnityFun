...
namespace TeoGames.Mesh_Combiner.Scripts.Combine.Lod {
	...
	[HelpURL("https://teogames.gitbook.io/dynamic-mesh-combiner/components/mc-combinable/mc-lod-combinable")]
	public class LodCombinable : Combinable {
		...
		protected override BakeStatus GetBakeStatus() {
			return LastCombiner && IsActive && LastCombiner.Lod.Combiner.IsBaked(this)
				? BakeStatus.Baked
				: BakeStatus.NotBaked;
		}
