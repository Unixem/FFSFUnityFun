...
namespace TeoGames.Mesh_Combiner.Scripts.Combine.MaterialStorage {
	...
	public abstract class AbstractMaterialStorage {
		...
		public abstract MaterialType Get(long mID, Material mat, int offset, ShadowCastingMode shadow, bool isStatic, IndexFormat format);
		public abstract bool TryFind(long matID, out BasicMaterial mat);

		protected BasicMaterial GetMaterialInstance(ShadowCastingMode shadow, bool isStatic, Material mat, IndexFormat format) {
