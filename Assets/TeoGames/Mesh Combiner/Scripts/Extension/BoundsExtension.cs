...
namespace TeoGames.Mesh_Combiner.Scripts.Extension {
	public static class BoundsExtension {
		...
		public static IEnumerable<Vector3> GetEdges(this Bounds b, Vector3 offset = default) {
			// bottom
			yield return new Vector3(b.min.x, b.min.y, b.min.z) + offset;
			yield return new Vector3(b.max.x, b.min.y, b.min.z) + offset;
			yield return new Vector3(b.max.x, b.min.y, b.max.z) + offset;
			yield return new Vector3(b.min.x, b.min.y, b.max.z) + offset;

			// top
			yield return new Vector3(b.min.x, b.max.y, b.min.z) + offset;
			yield return new Vector3(b.max.x, b.max.y, b.min.z) + offset;
			yield return new Vector3(b.max.x, b.max.y, b.max.z) + offset;
			yield return new Vector3(b.min.x, b.max.y, b.max.z) + offset;
		}
