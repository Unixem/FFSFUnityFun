...
namespace Bewildered.SmartLibrary
{
    internal static class AssetUtility
    {
        ...
        private static Lazy<Func<string, EntityId>> _getMainAssetEntityID = new Lazy<Func<string, EntityId>>(() => 
            (Func<string, EntityId>)TypeAccessor.GetMethod<AssetDatabase>("GetMainAssetEntityId")
                .CreateDelegate(typeof(Func<string, EntityId>)));
#else
...
#if UNITY_6000_4_OR_NEWER
        /// <summary>
        /// Returns the Entity ID of an asset object from the provided GUID.
        /// </summary>
        /// <param name="guid">The GUID of the asset to get the Entity ID of.</param>
        public static EntityId GetMainAssetEntityIDFromGUID(string guid)
        {
            return GetMainAssetEntityID(AssetDatabase.GUIDToAssetPath(guid));
        }

        public static EntityId GetMainAssetEntityID(string assetPath)
        {
            return _getMainAssetEntityID.Value(assetPath);
        }
#else
        /// <summary>
