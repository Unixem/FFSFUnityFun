...
namespace Bewildered.SmartLibrary
{
    ...
    public static class AssetPreviewManager
    {
        ...
        private static readonly HashSet<(string guid, EntityId clientID)> _previewRequests = new HashSet<(string guid, EntityId clientID)>();
#else
...
#if UNITY_6000_4_OR_NEWER
        public static Texture2D GetAssetPreview(string guid, EntityId clientID)
#else
...
#if UNITY_6000_4_OR_NEWER
        public static Texture2D GetAssetPreview(string guid, EntityId clientID, out bool generated)
#else
...
#if UNITY_6000_4_OR_NEWER
        private static Texture2D GetUnityAssetPreview(string assetPath, System.Type assetType, EntityId clientID)
#else
...
#endif
        {
...
#if UNITY_6000_4_OR_NEWER
            var assetId = AssetUtility.GetMainAssetEntityID(assetPath);
#else
            var assetId = AssetUtility.GetMainAssetInstanceID(assetPath);
#endif
            ...
            Texture2D preview = AssetPreviewRef.GetAssetPreview(assetId, clientID);
            if (preview != null)
                return preview;
...
#if UNITY_6000_4_OR_NEWER
        public static void ClearTemporaryAssetPreviews(EntityId clientID)
#else
        ...
        {
            foreach ((string guid, var clientID) in _previewRequests)
            {
