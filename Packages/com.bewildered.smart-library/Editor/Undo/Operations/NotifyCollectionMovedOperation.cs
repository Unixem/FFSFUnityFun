...
namespace Bewildered.SmartLibrary.UndoSystem
{
    ...
    internal class NotifyCollectionMovedOperation : UndoOperation
    {
        ...
        public override void Undo()
        {
            ...
            _parentCollection = (LibraryCollection)EditorUtility.EntityIdToObject(_parentCollection.GetEntityId());
            _subcollection = (LibraryCollection)EditorUtility.EntityIdToObject(_subcollection.GetEntityId());
#else
