...
#pragma warning disable CS0618 // Disable obsolete warning since the Component commands still use instance id.
                    var obj = (MonoScript)EditorUtility.EntityIdToObject(instanceID);
