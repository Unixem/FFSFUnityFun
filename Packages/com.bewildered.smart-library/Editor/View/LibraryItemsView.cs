...
namespace Bewildered.SmartLibrary.UI
{
...
#endif
    {
...
#if UNITY_6000_4_OR_NEWER
            int controlID = _ownerId.GetHashCode() + 10000;
#else
        ...
        private void BuildContextMenu(ContextualMenuPopulateEvent evt)
        {
            ...
            {
#if UNITY_6000_4_OR_NEWER
                evt.menu.AppendAction("Open", a => AssetDatabase.OpenAsset(targetItem.EntityId));
#else
...
#if UNITY_6000_4_OR_NEWER
                evt.menu.AppendAction("Ping", a => EditorGUIUtility.PingObject(targetItem.EntityId));
#else
        ...
        private void AddDirtyStateTracking(LibraryItem item)
        {
            ...
            _lastDrawnAssetDirtyCounts.Add(EditorUtility.GetDirtyCount(item.EntityId));
#else
        ...
        public void ForceRegenerateDirtyAssetPreviews()
        {
            ...
            {
#if UNITY_6000_3_OR_NEWER
                int dirtyCount = EditorUtility.GetDirtyCount(_lastDrawnAssetItems[i].EntityId);
#else
        ...
        public void SetItemsSource(IEnumerable<LibraryItem> items)
        {
            ...
            if (_sourceCollectionEditor != null)
                Object.DestroyImmediate(_sourceCollectionEditor);
        ...
        {
#if UNITY_6000_4_OR_NEWER
            _ownerId = evt.destinationPanel.GetOwner().GetEntityId();
#else
