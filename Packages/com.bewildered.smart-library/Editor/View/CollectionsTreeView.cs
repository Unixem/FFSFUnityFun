...
namespace Bewildered.SmartLibrary.UI
{
...
#endif
    {
        ...
        public void ScrollToCollection(LibraryCollection collection)
        {
            ...
            ScrollToItem(collection.GetEntityId().GetHashCode());
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            int id = collection.GetEntityId().GetHashCode();
#else
...
#if UNITY_6000_4_OR_NEWER
                SetSelection(collection.GetEntityId().GetHashCode());
#else
        ...
        private void OnLibraryHierarchyChanged(LibraryHierarchyChangedEventArgs evt)
        {
            ...
            if (evt.type is HierarchyChangeType.Removed)
            {
                ...
                {
#if UNITY_6000_4_OR_NEWER
                    var parentItem = FindItem(evt.collection.GetEntityId().GetHashCode());
#else
            ...
            {
#if UNITY_6000_4_OR_NEWER
                BTreeViewItem parentItem = FindItem(evt.collection.GetEntityId().GetHashCode());
#else
