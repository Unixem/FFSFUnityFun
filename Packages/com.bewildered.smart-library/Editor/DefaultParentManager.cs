...
namespace Bewildered.SmartLibrary
{
    ...
    internal static class DefaultParentManager
    {
...
#endif
        {
            ...
            GameObject instance = EditorUtility.EntityIdToObject(instanceID) as GameObject;
#else
...
#if UNITY_6000_3_OR_NEWER
                var newGameObject = EditorUtility.EntityIdToObject(data.entityId) as GameObject;
#else
        ...
        private static void SetAsDefaultParent(object userData)
        {
            ...
            {
#if UNITY_6000_4_OR_NEWER
                var parentLinks = Object.FindObjectsByType<CollectionDefaultParent>();
