...
namespace Bewildered.SmartLibrary
{
    ...
    public class LibraryItem
    {
        ...
        [NonSerialized] private EntityId _entityId;
#endif
        ...
        public int InstanceID
        {
            get
            {
                ...
                if (_instanceID == 0)
                    _instanceID = AssetUtility.GetMainAssetEntityIDFromGUID(_guid);
#else
                if (_instanceID == 0)
        ...
        /// <summary>
        /// Returns the EntityID of the asset referenced by the <see cref="LibraryItem"/>.
        /// </summary>
#if UNITY_6000_3_OR_NEWER
        public EntityId EntityId
        {
            get
            {
                if (_entityId == EntityId.None)
                    _entityId = AssetUtility.GetMainAssetEntityIDFromGUID(_guid);
